...
-- [回答] SELECT store_table.store_name,goods_table.goods_name,
          stock_table.quantity,stock_table.store_code, stock_table.goods_code
          FROM stock_table INNER JOIN store_table 
...
-- [回答] SELECT COUNT(price) FROM goods_table
